...
contract SpaceXProtocol is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    // Burn address
    address public constant TEAM_ADDRESS =
        0x4Dd6E8A403cD88d4761eb4862789180C393753cD;
    ...
    string private _name = "Space X Protocol";
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            require(
                ...
                "SPX::transfer: Mkt value invalid"
            );
